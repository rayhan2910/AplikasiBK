                ...
                <div class="panel panel-bordered">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            $row = $dataTypeRows->where('field', 'kehadiran_belongsto_siswa_relationship')->first();
                            $options = $row->details;
                            @endphp
                        ...
                        <div class="form-group">
                            <label for="kelas">Sakit</label>
                            <input type="number" class="form-control" id="sakit" name="sakit" placeholder="Berapa Hari?...." value="{{ old('sakit', $dataTypeContent->sakit ?? '') }}">
                        </div>
                        <div class="form-group">
                            <label for="kelas">Izin</label>
                            <input type="number" class="form-control" id="izin" name="izin" placeholder="Berapa Hari?...." value="{{ old('izin', $dataTypeContent->izin ?? '') }}">
                        </div>
                        <div class="form-group">
                            <label for="kelas">Alpa</label>
                            <input type="number" class="form-control" id="alpa" name="alpa" placeholder="Berapa Hari?...." value="{{ old('alpa', $dataTypeContent->alpa ?? '') }}">
                        </div>
                        <div class="form-group">
